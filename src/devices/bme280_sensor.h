...
typedef void (*bme280_sensor_lock_i2c_callback_t) ();
...
{
    bme280_sensor_lock_i2c_callback_t lock_i2c_callback;
    bme280_sensor_lock_i2c_callback_t unlock_i2c_callback;
