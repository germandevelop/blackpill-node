...
void board_factory_build_setup (board_setup_t * const setup)
{
    ...
    const uint8_t unique_id_T01[] = { 0x53, 0x00, 0x56, 0x00, 0x0e, 0x51, 0x38, 0x30, 0x38, 0x33, 0x31, 0x31 };
    const uint8_t unique_id_B02[] = { 0x2F, 0x00, 0x37, 0x00, 0x0B, 0x51, 0x35, 0x33, 0x31, 0x36, 0x39, 0x33 };
